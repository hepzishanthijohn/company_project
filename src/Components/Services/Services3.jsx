            ...
            <div className="row">
              <div className="col-lg-6 m-auto text-center">
                <div className="heading3">
                  <span className="span" data-aos="zoom-in-left" data-aos-duration="700">Our Industries</span>
                  <h2 className="title tg-element-title">Expertise Across Multiple Industries</h2>
                </div>
              </div>
            </div>
            ...
            <div className="row align-items-center">
              <div className="col-lg-4">
                <div className="" data-aos="fade-right" data-aos-duration="700">
                  <div className="service3-box">
                    ...
                    <div className="heading3">
                      <h4><Link to="/service/service-details">Retail</Link></h4>
                ...
                <div className="" data-aos="fade-right" data-aos-duration="1100">
                  <div className="service3-box">
                    ...
                    <div className="heading3">
                      <h4><Link to="/service/service-details">Banking & Finance</Link></h4>
                      <div className="space16"></div>
                ...
                <div className="" data-aos="fade-right" data-aos-duration="900">
                  <div className="service3-box">
                    ...
                    <div className="heading3">
                      <h4><Link to="/service/service-details">E-governance</Link></h4>
                      <div className="space16"></div>
              ...
              <div className="col-lg-4">
                <div className="main-image image-anime">
                  ...
                  <img src="/assets/img/people/ind.webp" alt="" />
              ...
              <div className="col-lg-4">
                <div className="" data-aos="fade-left" data-aos-duration="700">
                  <div className="service3-box">
                    ...
                    <div className="heading3">
                      <h4><Link to="/service/service-details">Software & Hi-Tech</Link></h4>
                      <div className="space16"></div>
                ...
                <div className="" data-aos="fade-left" data-aos-duration="1100">
                  <div className="service3-box">
                    ...
                    <div className="heading3">
                      <h4><Link to="/service/service-details">Healthcare</Link></h4>
                      <div className="space16"></div>
                ...
                <div className="" data-aos="fade-left" data-aos-duration="900">
                  <div className="service3-box">
                    ...
                    <div className="heading3">
                      <h4><Link to="/service/service-details">Consumer Technology</Link></h4>
                      <div className="space16"></div>
