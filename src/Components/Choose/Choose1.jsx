...
const Choose1 = () => {
    ...
    const mainContent = {
        ...
        Content:'At Zigma, we understand that every business is unique, which is why we offer a range of flexible IT solutions designed to address your specific challenges and goals.',
        btnName:'Discover More',
        btnUrl:'/contact',
        // img1:'/assets/img/work/work-img1.png',
        // img2:'/assets/img/work/work-img3.png',
        // img3:'/assets/img/work/work-img2.png',
        img1:'/assets/img/people/image1.webp',
        img2:'/assets/img/people/image3.webp',
        img3:'/assets/img/people/image2.webp',
      }
