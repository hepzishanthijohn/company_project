...
const Footer3 = () => {
    return (
        ...
        <div className="_relative footer_3">
                  ...
                  <div className="row">
                    <div className="col-lg-8 m-auto text-center">
                      <div className="heading2">
                        ...
                        <p>At Zigma IT Solutions, we are dedicated to delivering innovative technology solutions <br/> tailored to meet the unique needs of businesses like yours. </p>
                            ...
                            <div className="subscribe-form">
                              <form action="#">
                                ...
                                <div className="button">
                                  <button className="theme-btn4 btn--ripple ripple">Get Started Now <i className="bi bi-arrow-right"></i></button>
                                </div>
                              </form>
                            </div>
            ...
            <div className="footer3 _relative">
            <div className="container">
                    <div className="row">
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="single-footer-items footer-logo-area">
                                <div className="footer-logo">
                                    <a href=""><img src="/assets/img/logo/header3-logo.png" alt="" /></a>
                                </div>
                                <div className="space20"></div>
                                <div className="heading2">
                                    <p>At Zigma IT Solutions, we are dedicated to delivering innovative technology solutions tailored to meet the unique needs of businesses like yours. </p>
                                </div>
                        ...
                        <div className="col-lg-3 col-md-6 col-12">
                            <div className="single-footer-items">
                                ...
                                <div className="contact-box">
                                    ...
                                    <div className="pera">
                                    <a href="mailto:admin@Zigma.org">admin@Zigma.org</a>
                                    </div>
                                </div>
                                ...
                                <div className="contact-box">
                                    ...
                                    <div className="pera">
                                    <a href="mailto:admin@Zigma.org">www.Zigma.org</a>
                                    </div>
                                </div>
